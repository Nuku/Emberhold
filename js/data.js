...
const TECHS = [
  ...
  { id: 'ironMites', name: 'Iron Mites', cost: 900,
    desc: 'Use ancient iron-devouring insects to get deeper into the stone, increasing Iron Miner efficiency by 30%.',
    req: () => bld('forge') > 0 },
  ...
  { id: 'spies', name: 'Spies', cost: 1400,
    desc: 'Unlocks target-specific spy training. One spy reveals Military strength; two reveal Economic strength, though spies may be caught over time.',
    req: () => era() >= 3 && tech('diplomacy') },
  { id: 'espionage', name: 'Espionage', cost: 2400,
    desc: 'Spies can spend 20 minutes attempting to weaken a town\'s Military strength. Each attempt has a 60% chance of success.',
